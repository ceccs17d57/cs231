...
void roundrobin(int bt[],int rt[],int n,int timequantum)
{
int i=0,flag=0;
...
void main()
{
	int y=1,choice,bt[20],wt[20],n,i,tt[20],p[20],rt[20],timequantum;
	...
	while(y=1)
	{
		...
		switch (choice){
			...
			case 2: sjf(wt,bt,n);
				break;
			case 3: roundrobin(bt,rt,n,timequantum);
				break;
